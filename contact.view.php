    ...
    <div class="min-h-full">
                        ...
                        <div class="hidden md:block">
                            <div class="hidden md:block">
                                <div class="ml-10 flex items-baseline space-x-4">
                                    ...
                                    <a href="/contact.php" class="bg-gray-900 text-white hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium aria-current="page"">contact Us</a>
        ...
        <header class="bg-white shadow">
            <div class="mx-auto max-w-7xl py-6 px-4 sm:px-6 lg:px-8">
                <h1 class="text-3xl font-bold tracking-tight text-gray-900">Contact Us Page</h1>
            </div>
        </header>
        <main>
